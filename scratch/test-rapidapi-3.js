...
const urlsToTry = [
  { url: 'https://skyscanner-flights-travel-api.p.rapidapi.com/flights/live/search/create', headers: headers2 },
  { url: 'https://skyscanner-flights-travel-api.p.rapidapi.com/v1/flights/search', headers: headers2 },
